    ...
    $_urlDICJ = "http://www.dicj.info/etu/2030501/Lab03_HenocAKRE/lab2_IntroAuPHP.html";
    ...
    if ($isConnected == false &&  $_urlPHP != "lab2_IntroAuPHP.html")
    {
        flush();
        echo "<script type='text/javascript'> document.location = 'lab2_IntroAuPHP.html'; </script>";
        exit();
    }
    ?>
